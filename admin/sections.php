          ...
          <div class="row">
            <?php
              $stmt = $mysqli->prepare("SELECT 
                ...
                SUM(CASE when  status IS NULL OR status = 2 THEN 1 ELSE 0 END) AS pending,
                SUM(CASE when  status = 3 OR status = 4 THEN 1 ELSE 0 END) AS reviewed,
              ...
              <a href="index.php"><div class="card border-left-primary shadow h-100 py-2">
                              <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                  <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Scored Applications</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <a href="reviewed.php"><div class="card border-left-success shadow h-100 py-2">
                              <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                  <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Reviwed Applications</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $reviewed; ?></div>
                                  </div>
                                  <div class="col-auto">
